...
/** 
 * DAO for table "NEW_MAP".
*/
public class NewMapDao extends AbstractDao<NewMap, Void> {

    public static final String TABLENAME = "NEW_MAP";

    /**
     * Properties of entity NewMap.<br/>
    ...
    */
    ...
    public NewMapDao(DaoConfig config) {
        super(config);
    }
    
    public NewMapDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"NEW_MAP\" (" + //
                "\"ID\" TEXT," + // 0: id
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"NEW_MAP\"";
        db.execSQL(sql);
    }

    @Override
    protected void bindValues(DatabaseStatement stmt, NewMap entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, NewMap entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public NewMap readEntity(Cursor cursor, int offset) {
        NewMap entity = new NewMap( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, NewMap entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(NewMap entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(NewMap entity) {
        return null;
    }
    ...
    @Override
    protected boolean hasKey(NewMap entity) {
        return false;
    }
}
