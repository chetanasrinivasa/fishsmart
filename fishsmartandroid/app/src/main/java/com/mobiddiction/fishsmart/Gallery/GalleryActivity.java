...
public class GalleryActivity extends BaseTabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState/*, R.layout.activity_gallery, false*/);
        setContentView(R.layout.activity_gallery);
        HomeTextChanger("GALLERY", this);
        //((MyApplication) getApplication()).getTrackingManager().trackScreen(ScreenEnum.GALLERY, null);
        FirebaseAnalytics.getInstance(getApplicationContext()).setCurrentScreen(this,ScreenEnum.GALLERY, null);

        galleryFragment = new GalleryFragment().newInstance(false);
        if (savedInstanceState == null) {
            Log.d(TAG , "Adding galleryFragment");
        ...
        imgNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GalleryActivity.this, NotificationActivity.class);
        ...
        nav_title.setText(Html.fromHtml("GALLERY"));
