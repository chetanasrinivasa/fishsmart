 ...
 */
public class LicenseActivity extends BaseTabActivity {

    LicensingFragment licensingFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeTextChanger("Licensing", this);
        ...
        licensingFragment = new LicensingFragment();

        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().add(R.id.container, new LicensingFragment()).commit();
        }
        ...
        imgNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LicenseActivity.this, NotificationActivity.class);
        ...
        imgUser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LicenseActivity.this, ProfileActivity.class);
                startActivity(intent);
            }
        });
        ...
        nav_title.setText(Html.fromHtml("Licensing"));
    ...
    protected void onStart() {
        ...
        if (userBean.image.size() > 0) {
            LicenseActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {

                    Glide.with(LicenseActivity.this)
                            .asBitmap()
