...
// KEEP INCLUDES END
/**
 * Entity mapped to table "FRESH_WATERFISH_FACTS".
 */
public class FreshWaterfishFacts {
    ...
    public FreshWaterfishFacts() {
    }

    public FreshWaterfishFacts(Integer id, String about, String FreshID, String size, String confusingSpecies, String characteristics) {
        this.id = id;
        this.about = about;
