...
/** 
 * DAO for table "ALL_SPECIESRULES".
*/
public class AllSpeciesrulesDao extends AbstractDao<AllSpeciesrules, Void> {

    public static final String TABLENAME = "ALL_SPECIESRULES";

    /**
     * Properties of entity AllSpeciesrules.<br/>
    ...
    */
    ...
    public AllSpeciesrulesDao(DaoConfig config) {
        super(config);
    }
    
    public AllSpeciesrulesDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ALL_SPECIESRULES\" (" + //
                "\"ID\" INTEGER," + // 0: id
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ALL_SPECIESRULES\"";
        db.execSQL(sql);
    }

    @Override
    protected void bindValues(DatabaseStatement stmt, AllSpeciesrules entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, AllSpeciesrules entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public AllSpeciesrules readEntity(Cursor cursor, int offset) {
        AllSpeciesrules entity = new AllSpeciesrules( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, AllSpeciesrules entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(AllSpeciesrules entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(AllSpeciesrules entity) {
        return null;
    }
    ...
    @Override
    protected boolean hasKey(AllSpeciesrules entity) {
        return false;
    }
}
