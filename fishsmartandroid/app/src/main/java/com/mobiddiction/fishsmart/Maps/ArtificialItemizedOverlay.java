 ...
 */
public class ArtificialItemizedOverlay extends ItemizedOverlay<OverlayItem> {

    private ArrayList<OverlayItem> overlayItemList = new ArrayList<OverlayItem>();
    MapsActivity ctx;

    public ArtificialItemizedOverlay(Drawable pDefaultMarker, ArrayList<OverlayItem> overlayItemList, MapsActivity context) {
