...
/** 
 * DAO for table "ALL_SPECIES_GROUP".
*/
public class AllSpeciesGroupDao extends AbstractDao<AllSpeciesGroup, Void> {

    public static final String TABLENAME = "ALL_SPECIES_GROUP";

    /**
     * Properties of entity AllSpeciesGroup.<br/>
    ...
    */
    ...
    public AllSpeciesGroupDao(DaoConfig config) {
        super(config);
    }
    
    public AllSpeciesGroupDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ALL_SPECIES_GROUP\" (" + //
                "\"ID\" INTEGER," + // 0: id
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ALL_SPECIES_GROUP\"";
        db.execSQL(sql);
    }

    @Override
    protected void bindValues(DatabaseStatement stmt, AllSpeciesGroup entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, AllSpeciesGroup entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public AllSpeciesGroup readEntity(Cursor cursor, int offset) {
        AllSpeciesGroup entity = new AllSpeciesGroup( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, AllSpeciesGroup entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(AllSpeciesGroup entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(AllSpeciesGroup entity) {
        return null;
    }
    ...
    @Override
    protected boolean hasKey(AllSpeciesGroup entity) {
        return false;
    }
}
