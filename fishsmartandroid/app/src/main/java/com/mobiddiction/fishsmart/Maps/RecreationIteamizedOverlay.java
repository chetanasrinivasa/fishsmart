 ...
 */
public class RecreationIteamizedOverlay extends ItemizedOverlay<OverlayItem> {

    private ArrayList<OverlayItem> overlayItemList = new ArrayList<OverlayItem>();
    MapsActivity ctx;

    public RecreationIteamizedOverlay(Drawable pDefaultMarker, ArrayList<OverlayItem> overlayItemList, MapsActivity context) {
