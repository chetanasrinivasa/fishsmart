 ...
 */
public class MarineItemizedOverlay extends ItemizedOverlay<OverlayItem> {

    private ArrayList<OverlayItem> overlayItemList = new ArrayList<OverlayItem>();
    MapsActivity ctx;

    public MarineItemizedOverlay(Drawable pDefaultMarker, ArrayList<OverlayItem> overlayItemList, MapsActivity context) {
