 ...
 */
public class ContactActivity extends BaseTabActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ContactActivity.this, NotificationActivity.class);
        ...
        nav_title.setText(Html.fromHtml("Contacts"));
