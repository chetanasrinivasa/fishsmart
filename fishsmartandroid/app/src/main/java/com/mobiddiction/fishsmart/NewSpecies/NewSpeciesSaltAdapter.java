...
public class NewSpeciesSaltAdapter extends RecyclerView.Adapter<NewSpeciesSaltAdapter.CustomViewHolder> {
    Context mContext;
    List<SaltWaterNewData> sources;
    Handler handler = new Handler();
    SpeciesDownloader speciesDownloader = SpeciesDownloader.getInstance();

    public NewSpeciesSaltAdapter(Context context, List<SaltWaterNewData> sources) {
    ...
    public void onBindViewHolder(@NonNull final CustomViewHolder customViewHolder, final int position) {
        try {
            ...
            if(saltWaterNew.getGroupName()!=null && !TextUtils.isEmpty(saltWaterNew.getGroupName().trim())){
                f_holder.exclamlayout.setVisibility(View.VISIBLE);
                f_holder.exclaimtext.setText(Utils.toTitleCase(saltWaterNew.getGroupName().toLowerCase()));
            }
            else{
                f_holder.exclamlayout.setVisibility(View.GONE);
            }
