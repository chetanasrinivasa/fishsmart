...
/** 
 * DAO for table "SALT_WATER_NEW_DATA".
*/
public class SaltWaterNewDataDao extends AbstractDao<SaltWaterNewData, Void> {

    public static final String TABLENAME = "SALT_WATER_NEW_DATA";

    /**
     * Properties of entity SaltWaterNewData.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property ByteThumbnailSalt = new Property(9, byte[].class, "byteThumbnailSalt", false, "BYTE_THUMBNAIL_SALT");
        public final static Property ByteImageSalt = new Property(10, byte[].class, "byteImageSalt", false, "BYTE_IMAGE_SALT");
    ...
    public SaltWaterNewDataDao(DaoConfig config) {
        super(config);
    }
    
    public SaltWaterNewDataDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SALT_WATER_NEW_DATA\" (" + //
                "\"ID\" TEXT," + // 0: id
                "\"TITLE\" TEXT," + // 1: title
                ...
                "\"BYTE_THUMBNAIL_SALT\" BLOB," + // 9: byteThumbnailSalt
                "\"BYTE_IMAGE_SALT\" BLOB," + // 10: byteImageSalt
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SALT_WATER_NEW_DATA\"";
        db.execSQL(sql);
    }

    @Override
    protected void bindValues(DatabaseStatement stmt, SaltWaterNewData entity) {
        stmt.clearBindings();
        ...
        byte[] byteThumbnailSalt = entity.getByteThumbnailSalt();
        if (byteThumbnailSalt != null) {
            stmt.bindBlob(10, byteThumbnailSalt);
        }

        byte[] byteImageSalt = entity.getByteImageSalt();
        if (byteImageSalt != null) {
            stmt.bindBlob(11, byteImageSalt);
        }
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SaltWaterNewData entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public SaltWaterNewData readEntity(Cursor cursor, int offset) {
        SaltWaterNewData entity = new SaltWaterNewData( //
            ...
            cursor.isNull(offset + 9) ? null : cursor.getBlob(offset + 9), // byteThumbnailSalt
            cursor.isNull(offset + 10) ? null : cursor.getBlob(offset + 10), // byteImageSalt
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, SaltWaterNewData entity, int offset) {
        ...
        entity.setByteThumbnailSalt(cursor.isNull(offset + 9) ? null : cursor.getBlob(offset + 9));
        entity.setByteImageSalt(cursor.isNull(offset + 10) ? null : cursor.getBlob(offset + 10));
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(SaltWaterNewData entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(SaltWaterNewData entity) {
        return null;
    }
    ...
    @Override
    protected boolean hasKey(SaltWaterNewData entity) {
        return false;
    }
}
