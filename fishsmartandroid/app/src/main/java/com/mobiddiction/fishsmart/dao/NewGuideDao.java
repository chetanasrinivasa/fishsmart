...
/** 
 * DAO for table "NEW_GUIDE".
*/
public class NewGuideDao extends AbstractDao<NewGuide, Void> {

    public static final String TABLENAME = "NEW_GUIDE";

    /**
     * Properties of entity NewGuide.<br/>
    ...
    */
    ...
    public NewGuideDao(DaoConfig config) {
        super(config);
    }
    
    public NewGuideDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"NEW_GUIDE\" (" + //
                "\"ID\" TEXT," + // 0: id
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"NEW_GUIDE\"";
        db.execSQL(sql);
    }

    @Override
    protected void bindValues(DatabaseStatement stmt, NewGuide entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, NewGuide entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public NewGuide readEntity(Cursor cursor, int offset) {
        NewGuide entity = new NewGuide( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, NewGuide entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(NewGuide entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(NewGuide entity) {
        return null;
    }
    ...
    @Override
    protected boolean hasKey(NewGuide entity) {
        return false;
    }
}
