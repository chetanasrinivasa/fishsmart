...
/** 
 * DAO for table "NOTIFICATION_DEVICE".
*/
public class NotificationDeviceDao extends AbstractDao<NotificationDevice, Void> {

    public static final String TABLENAME = "NOTIFICATION_DEVICE";

    /**
     * Properties of entity NotificationDevice.<br/>
    ...
    */
    ...
    public NotificationDeviceDao(DaoConfig config) {
        super(config);
    }
    
    public NotificationDeviceDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"NOTIFICATION_DEVICE\" (" + //
                "\"ID\" TEXT," + // 0: id
                "\"UDID\" TEXT," + // 1: udid
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"NOTIFICATION_DEVICE\"";
        db.execSQL(sql);
    }

    @Override
    protected void bindValues(DatabaseStatement stmt, NotificationDevice entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, NotificationDevice entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public NotificationDevice readEntity(Cursor cursor, int offset) {
        NotificationDevice entity = new NotificationDevice( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, NotificationDevice entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(NotificationDevice entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(NotificationDevice entity) {
        return null;
    }
    ...
    @Override
    protected boolean hasKey(NotificationDevice entity) {
        return false;
    }
}
